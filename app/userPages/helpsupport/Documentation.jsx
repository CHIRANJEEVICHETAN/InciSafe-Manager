    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.menuItem}>
          ...
          <View style={styles.bulletContainer}>
            <Text style={styles.bulletText}>- List of accepted file types for 
            uploads.</Text>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.bulletContainer}>
            <Text style={styles.bulletText}>- Maximum file sizes allowed for uploads and suggestions for reducing file size</Text>
