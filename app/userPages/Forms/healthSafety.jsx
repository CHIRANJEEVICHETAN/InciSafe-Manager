...
export default function HealthSafety() {
  ...
  const [violationTypes, setViolationTypes] = useState({
    injury: false,
    miss: false,
    unsafe: autoFill ? violationType === 'unsafe' : false,
  });
...
useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    const currentUser = auth.currentUser;
      ...
      if (notificationResponse.status === 200) {
        ...
        await setDoc(doc(db, "HealthSafety", customDocId), { notificationSent: true }, { merge: true });
      }
  ...
  const renderContent = () => (
    <View style={styles.contentContainer}>
      ...
      <Text style={styles.header}>Health & Safety Incident Violation</Text>
