    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.menuItem}>
          ...
          <View style={styles.bulletContainer}>
            <Text style={styles.bulletText}>-  User accounts may be suspended temporarily if thereare suspected violations of the terms, such as false reporting or misuse of the platform.</Text>
